...
SRC = main.cpp src/ui/button.cpp src/ui/inventory.cpp src/ui/main_menu.cpp src/ui/WindowManager/window_manager.cpp src/towers/towers.cpp src/towers/turret.cpp \
